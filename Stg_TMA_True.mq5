...
#ifdef __resource__
#ifdef __MQL5__
#property tester_indicator "::Indicators\\Indi_TMA_True.ex5"
#property tester_library "::Indicators\\Indi_TMA_True.ex5"
#endif
#endif
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_TMA_True>(Active_Tfs);
